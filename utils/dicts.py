...
variant_names = {'B.1.1.7': 'Alpha', 'B.1.1.7 (Alpha)': 'Alpha', 'VOC Alpha GRY (B.1.1.7+Q.*) first detected in the UK': 'Alpha',
                 ...
                 'P.1': 'Gamma', 'P.1.1': 'Gamma', 'VOC Gamma GR/501Y.V3 (P.1+P.1.*) first detected in Brazil/Japan': 'Gamma',
...
standardize_country_names = {'Republic of Burundi': 'Burundi', 'Republic of Cameroon': 'Cameroon',
                             ...
                             'Gabonese Republic': 'Gabon', 'Democratic Republic of São Tomé and Principe': 'São Tomé and Principe',
                             ...
                             'Kingdom of eSwatini': 'eSwatini', 'Swaziland': 'eSwatini', 'Kingdom of Lesotho': 'Lesotho',
                             ...
                             'Republic of Benin': 'Benin', 'Cape Verde': 'Cabo Verde', 'Republic of Cabo Verde': 'Cabo Verde',
                             'Republic of Côte d\'Ivoire': 'Côte d\'Ivoire', 'Republic of Gambia': 'Gambia',
                             'Republic of Ghana': 'Ghana', 'Republic of Guinea': 'Guinea',
                             'Republic of Guinea-Bissau': 'Guinea-Bissau', 'Republic of Liberia': 'Liberia', 'Republic of Mali': 'Mali',
                             'Republic of Niger': 'Niger', 'Federal Republic of Nigeria': 'Nigeria', 'Republic of Senegal': 'Senegal',
                             'Republic of Sierra Leone': 'Sierra Leone','Togolese': 'Togo', 'Togolese Republic': 'Togo'}
